...
//var app = angular.module('app', ['ui.router','ngAnimate','angular-echarts']);

app.controller('dataContrl', function ($scope) {
					//var myGauge=require('echarts').init(document.getElementById("myGauge"));
